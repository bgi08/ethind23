...
bottomsvg = '''Hi {}</text>
  <text x="50%" y="30%" class="add" dominant-baseline="middle" text-anchor="middle">Your soulprint is {} Tons of C02</text>
...
def gen_sol(svg):
    ...
    with open("contracts/soulprint.sol", "w") as f:
        f.write(solidity)
...
def encodedjson(address, cotons, trans):
    preffix = '''{"name":"soulprint","description":"a nft of your carbon soulprint","image":"data:image/svg+xml;base64,'''
    c1, c2 = randomcolors()
